...
const baseCopy = {
  en: {
    ...
    legalLanguageGroup: 'Document language',
  ...
  ar: {
    ...
    languageArabic: 'العربية',
    languageFrench: 'Français',
    legalLanguageGroup: 'لغة المستند',
...
export const copy = {
  ...
  fr: {
    ...
    languageLabel: 'Langue', languageEnglish: 'English', languageArabic: 'العربية', languageFrench: 'Français', legalLanguageGroup: 'Langue du document', appearanceLabel: 'Apparence', appearanceSystem: 'Système', appearanceLight: 'Clair', appearanceDark: 'Sombre',
