...
const baseCopy = {
  en: {
    ...
    signInIdentityHint: 'Use the email address or the phone number you registered with.',
    ...
    createCustomerBody:
      'Describe a job, receive quotes, and agree a price before the work starts.',
    createWorkerBody:
      'Register your trades, complete verification, and quote the jobs you want.',
    ...
    createFootNote:
      ...
      + 'professional on Warsha, and approval is not automatic.',
    createHaveAccount: 'Already have an account?',
  ...
  ar: {
    ...
    signInIdentityHint: 'استخدم البريد الإلكتروني أو رقم التليفون اللي سجّلت بيه.',
    ...
    createCustomerBody:
      'اوصف الشغل، استنى العروض، واتفق على السعر قبل ما الشغل يبدأ.',
    createWorkerBody:
      'سجّل مهنتك، كمّل التوثيق، وقدّم سعرك على الشغل اللي يناسبك.',
    ...
    createFootNote:
      ...
      + 'تلقائي.',
    createHaveAccount: 'عندك حساب بالفعل؟',
...
export const copy = {
  ...
  fr: {
    ...
    signInTitle: 'Se connecter à Warsha', signInEyebrow: 'Heureux de vous revoir', signInIdentityHint: 'Utilisez l’adresse e-mail ou le numéro de téléphone enregistré. Warsha détermine le type de compte.', signInCustomer: "J'ai besoin d'un service", signInWorker: 'Je réalise les travaux', signInFootNote: "Vous n'avez pas encore de compte ?", signInFootLink: 'Créez-en un',
    createTitle: 'Comment souhaitez-vous utiliser Warsha ?', createEyebrow: 'Créer un compte', createLead: 'Choisissez ce qui vous correspond. Vous pouvez lire chaque accord requis avant de l’accepter.', createCustomerBody: 'Décrivez un travail, recevez des devis et acceptez le prix avant le début.', createWorkerBody: 'Enregistrez vos métiers, terminez la vérification et répondez aux demandes qui vous intéressent.', createRequiredHeading: 'Vous devrez accepter', createWorkerInApp: 'Les professionnels s’inscrivent dans l’application Warsha.', createFootNote: 'La candidature comme professionnel déclenche une vérification. Elle ne vaut pas approbation automatique.', createHaveAccount: 'Vous avez déjà un compte ?',
