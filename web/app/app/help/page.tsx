...
export default function AppHelpPage() {
  ...
  return <AppShell nav={worker ? workerNav(words) : customerNav(words)} mode={worker ? words.modeWorker : words.modeCustomer}><HelpManual locale={locale} articles={articles}/></AppShell>;
}
