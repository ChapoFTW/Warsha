...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  input: { flex: 1, color: colors.inputText, fontFamily: typography.family, fontSize: typography.body.fontSize, paddingVertical: 0, minHeight: 44 },
  iconButton: { width: 44, height: 44, alignItems: 'center', justifyContent: 'center' },
  sortRow: { gap: spacing.sm },
  sectionLabel: { ...typography.bodySmall, fontWeight: typography.semibold },
  ...
  noticeHint: { ...typography.caption, letterSpacing: 0, color: colors.textSecondary },
  ...
  retryText: { ...typography.bodySmall, fontWeight: typography.semibold },
  landing: { gap: spacing.xl },
  block: { gap: spacing.sm },
  blockHead: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  blockHint: { ...typography.caption, letterSpacing: 0, color: colors.textMuted },
  state: { alignItems: 'center', padding: spacing.xxxl, gap: spacing.md },
  stateTitle: { ...typography.h3, fontWeight: typography.semibold, textAlign: 'center' },
  ...
  moreText: { ...typography.bodySmall, color: colors.actionPrimaryText, fontWeight: typography.bold },
  end: { ...typography.caption, letterSpacing: 0, marginTop: spacing.lg, color: colors.textMuted, textAlign: 'center' },
});
