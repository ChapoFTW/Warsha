...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  amount: { ...typography.display, fontWeight: typography.bold, textAlign: 'center' },
  ...
  metricValue: { ...typography.h3, fontWeight: typography.bold },
  ...
  grow: { flex: 1, gap: 3 },
  title: { ...typography.h3, fontWeight: typography.bold },
  ...
  fieldLabel: { ...typography.bodySmall, fontWeight: typography.semibold },
  ...
  transactionTitle: { ...typography.bodySmall, fontWeight: typography.semibold },
  transactionAmount: { ...typography.bodySmall, fontWeight: typography.bold },
