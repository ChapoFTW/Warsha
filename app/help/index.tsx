...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  sectionTitle: { ...typography.bodySmall, fontWeight: typography.semibold, color: colors.textSecondary },
  ...
  categoryTitle: { ...typography.body, fontWeight: typography.semibold },
  categoryBody: { ...typography.bodySmall, color: colors.textSecondary },
  ...
  articleTitle: { ...typography.body, fontWeight: typography.semibold },
  articleBody: { ...typography.bodySmall, color: colors.textSecondary },
  contact: { gap: spacing.md },
  contactTitle: { ...typography.h3, fontWeight: typography.bold },
  contactBody: { ...typography.bodySmall, color: colors.textSecondary },
});
