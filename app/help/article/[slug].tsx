...
export default function HelpArticleScreen() {
  ...
  const load = useCallback(async () => {
    if (language === 'fr' || !support.accountKey || !slug) return;
    setState('loading');
  ...
  }, [language, slug, support.accountKey, support.locale]);
...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  feedbackTitle: { ...typography.body, fontWeight: typography.semibold },
  ...
  feedbackLabel: { ...typography.body, fontWeight: typography.medium },
  ...
  relatedTitle: { ...typography.body, fontWeight: typography.semibold },
  relatedBody: { ...typography.bodySmall, color: colors.textSecondary },
});
