...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  filters: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm }, filter: { minHeight: 44, paddingHorizontal: spacing.md, borderWidth: 1, borderColor: colors.border, borderRadius: radii.pill, alignItems: 'center', justifyContent: 'center' }, filterSelected: { backgroundColor: colors.white, borderColor: colors.white }, filterText: { ...typography.bodySmall, color: colors.textSecondary }, filterTextSelected: { color: colors.background, fontWeight: typography.bold },
  markAll: { alignSelf: 'flex-start', minHeight: 44, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, paddingHorizontal: spacing.md, borderWidth: 1, borderColor: colors.border, borderRadius: radii.pill }, markAllText: { ...typography.bodySmall, fontWeight: typography.semibold },
  ...
  grow: { flex: 1, gap: 5 }, meta: { flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', gap: spacing.sm }, category: { ...typography.caption, letterSpacing: 0, color: colors.textSecondary }, priority: { ...typography.caption, letterSpacing: 0, color: colors.textMuted }, count: { ...typography.caption, letterSpacing: 0, minWidth: 22, textAlign: 'center', color: colors.background, backgroundColor: colors.white, borderRadius: radii.pill, overflow: 'hidden' },
  title: { ...typography.body, fontWeight: typography.bold }, body: { ...typography.bodySmall, color: colors.textSecondary }, bottom: { flexDirection: 'row', justifyContent: 'space-between', flexWrap: 'wrap', gap: spacing.sm, marginTop: spacing.xs }, time: { ...typography.caption, letterSpacing: 0, color: colors.textMuted }, action: { ...typography.caption, letterSpacing: 0, color: colors.textPrimary, fontWeight: typography.semibold },
