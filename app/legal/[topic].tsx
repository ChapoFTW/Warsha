...
const body = {
  en: {
    help: [
      ...
      'If you are creating a worker account, you will be asked for identity documents, which our team reviews. Warsha does not currently ask for a criminal-record certificate.',
    ...
    privacy: [
      ...
      'Identity documents, and any criminal-record certificate sent before Warsha stopped asking for one, are stored privately. Only our verification team can open them, and every time one is opened it is recorded.',
    ...
    terms: [
      ...
      'Worker accounts have additional terms covering identity checks and the conditions under which an account can be suspended.',
  ...
  ar: {
    help: [
      ...
      'لو بتعمل حساب صنايعي، هنطلب منك إثبات شخصية والفريق بيراجعه. ورشة مش بتطلب فيش وتشبيه دلوقتي.',
    ...
    privacy: [
      ...
      'إثبات الشخصية، وأي فيش وتشبيه اتبعت قبل ما ورشة توقف طلبه، بيتخزنوا بشكل خاص. فريق التحقق بس اللي يقدر يفتحهم، وكل مرة بيتفتحوا بتتسجل.',
    ...
    terms: [
      ...
      'حسابات الصنايعية ليها شروط زيادة بتغطي التحقق من الهوية، والحالات اللي ممكن يتوقف فيها الحساب.',
