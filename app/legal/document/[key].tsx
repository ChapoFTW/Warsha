...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  governing: { ...typography.bodySmall, color: colors.textSecondary },
  notice: { ...typography.body, color: colors.textSecondary },
  section: { gap: spacing.sm },
  heading: { ...typography.h3, fontWeight: typography.semibold, color: colors.textPrimary },
  paragraph: { ...typography.body, color: colors.textSecondary },
  bulletRow: { flexDirection: 'row', gap: spacing.sm, alignItems: 'flex-start' },
  reverse: { flexDirection: 'row-reverse' },
  bulletMark: { ...typography.body, color: colors.textMuted },
  bulletText: { ...typography.body, flexGrow: 1, flexShrink: 1, color: colors.textSecondary },
