...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  safetyText: { ...typography.caption, letterSpacing: 0, color: colors.textSecondary },
  list: { padding: spacing.lg, gap: spacing.sm },
  listEmpty: { flexGrow: 1 },
  empty: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: spacing.sm, padding: spacing.xxl },
  emptyTitle: { ...typography.h3, fontWeight: typography.semibold },
  emptyBody: { ...typography.bodySmall, textAlign: 'center', color: colors.textMuted },
  ...
  body: { ...typography.body, color: colors.background },
  otherBody: { color: colors.textPrimary },
  meta: { flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end', gap: 6 },
  time: { ...typography.caption, letterSpacing: 0, color: colors.textMuted },
  ...
  systemText: { ...typography.caption, letterSpacing: 0, textAlign: 'center', color: colors.textMuted },
  typing: { ...typography.bodySmall, paddingHorizontal: spacing.lg, paddingBottom: spacing.xs, color: colors.textMuted },
  uploading: { ...typography.caption, letterSpacing: 0, color: colors.textMuted, textAlign: 'center', paddingBottom: spacing.xs },
  ...
  failedText: { ...typography.caption, letterSpacing: 0, color: colors.error, textAlign: 'center' },
  ...
  quickReplyText: { ...typography.bodySmall },
  ...
  readOnlyText: { ...typography.bodySmall, maxWidth: 520, color: colors.textMuted, textAlign: 'center' },
  reverse: { flexDirection: 'row-reverse' },
  iconButton: { width: 44, height: 44, alignItems: 'center', justifyContent: 'center' },
  input: { flex: 1, maxHeight: 110, minHeight: 44, borderWidth: 1, borderColor: colors.border, borderRadius: radii.lg, paddingHorizontal: spacing.md, paddingVertical: spacing.sm, color: colors.white, fontSize: typography.body.fontSize },
  ...
  reportTitle: { ...typography.h3, fontWeight: typography.bold },
  reportBody: { ...typography.bodySmall, color: colors.textSecondary },
