...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  title: { ...typography.h1, fontWeight: typography.bold, textAlign: 'center' }, body: { ...typography.body, color: colors.textSecondary, textAlign: 'center' },
  field: { gap: spacing.sm }, label: { ...typography.bodySmall, color: colors.textSecondary, fontWeight: typography.medium },
