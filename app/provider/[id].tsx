...
const styles = StyleSheet.create({
  ...
  name: { ...typography.h1, fontWeight: typography.bold, flexShrink: 1 },
  inline: {
    flexDirection: "row",
    alignItems: "center",
    gap: 4,
  ...
  strong: { ...typography.bodySmall, fontWeight: typography.semibold },
  stats: {
    flexDirection: "row",
  ...
  statValue: { ...typography.h3, fontWeight: typography.bold, textAlign: "center" },
  statLabel: { ...typography.caption, letterSpacing: 0, color: colors.textMuted, textAlign: "center" },
