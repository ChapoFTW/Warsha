...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  code: { ...typography.h1, fontWeight: typography.bold, letterSpacing: 2, color: colors.textPrimary },
  hint: { ...typography.bodySmall, color: colors.textMuted },
  sectionTitle: { ...typography.h3, fontWeight: typography.semibold, color: colors.textPrimary },
  step: { ...typography.bodySmall, color: colors.textPrimary },
  notice: { ...typography.bodySmall, color: colors.textSecondary },
  ...
  actionText: { ...typography.bodySmall, fontWeight: typography.semibold, color: colors.textPrimary },
  stat: { flexGrow: 1, minWidth: 90, gap: spacing.xs },
  statValue: { ...typography.h2, fontWeight: typography.bold, color: colors.textPrimary },
  statLabel: { ...typography.caption, letterSpacing: 0, color: colors.textMuted },
  ...
  rewardStatus: { ...typography.bodySmall, fontWeight: typography.semibold, color: colors.textPrimary },
  rewardWorth: { ...typography.bodySmall, color: colors.textPrimary },
  entryValue: { flexGrow: 1, minWidth: 140, minHeight: 44, paddingHorizontal: spacing.md, borderRadius: radii.md, borderWidth: 1, borderColor: colors.borderDefault, backgroundColor: colors.inputBackground, fontSize: typography.body.fontSize, letterSpacing: 1, color: colors.textPrimary },
  rtlText: { textAlign: 'right' },
  state: { alignItems: 'center', padding: spacing.xxxl, gap: spacing.md },
  stateTitle: { ...typography.h3, fontWeight: typography.semibold, color: colors.textPrimary, textAlign: 'center' },
  stateBody: { ...typography.bodySmall, color: colors.textMuted, textAlign: 'center' },
});
