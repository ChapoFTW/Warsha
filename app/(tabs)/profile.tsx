...
export default function Profile() {
  ...
  if (auth.mode === 'mock' || auth.user) return <Page>
    ...
    {phoneEnrollment ? <View style={styles.panel}>
      ...
      {otpSent ? <BrandButton label={at('resendOtp')} variant="secondary" size="compact" disabled={busy} onPress={() => void sendPhoneEnrollmentOtp()} style={styles.textButton} /> : null}
    </View> : <>
  ...
  return <Page>
    ...
    {classifySignInIdentity(email)?.kind === 'customer_email' ? <BrandButton label={t('forgotPassword')} variant="secondary" size="compact" disabled={busy} onPress={() => void requestReset()} style={styles.textButton} /> : null}
