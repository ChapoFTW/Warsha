...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  heading: { ...typography.h1, fontWeight: typography.bold },
  ...
  name: { ...typography.body, flex: 1, fontWeight: typography.bold },
  service: { ...typography.bodySmall, flexShrink: 1, color: colors.textSecondary },
  preview: { ...typography.bodySmall, flex: 1, color: colors.textMuted },
  ...
  badgeText: { ...typography.caption, letterSpacing: 0, color: colors.background, fontWeight: typography.bold },
