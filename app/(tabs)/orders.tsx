...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  title: { ...typography.h1, fontWeight: typography.bold },
  ...
  tabText: { ...typography.bodySmall, color: colors.textSecondary, fontWeight: typography.semibold },
  ...
  reviewErrorText: { ...typography.bodySmall, flex: 1, color: colors.error },
  ...
  reviewRetryText: { ...typography.bodySmall, fontWeight: typography.semibold },
  ...
  name: { ...typography.h3, fontWeight: typography.semibold, flexShrink: 1 },
  service: { ...typography.bodySmall, color: colors.textSecondary },
  meta: { ...typography.caption, letterSpacing: 0, color: colors.textMuted },
  ...
  details: { ...typography.bodySmall, fontWeight: typography.semibold },
  ...
  reviewed: { ...typography.bodySmall, color: colors.success, fontWeight: typography.semibold, textAlign: 'center' },
});
