        ...
        {state.certificates.map(item => {
          ...
          return (
            <View key={item.id} style={styles.card}>
              ...
              {editable ? <Pressable accessibilityRole="button" onPress={() => void chooseDocument(item)} style={styles.outline}><MaterialIcons accessibilityElementsHidden importantForAccessibility="no" name="upload-file" size={22} color={colors.white} /><AppText>{wt('chooseDocument')}</AppText></Pressable> : null}
