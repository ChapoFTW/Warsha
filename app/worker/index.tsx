...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  primaryTitle: { ...typography.h2, fontWeight: typography.bold, color: colors.textPrimary },
  primaryBody: { ...typography.body, color: colors.textSecondary },
  ...
  actionTitle: { ...typography.h3, flex: 1, fontWeight: typography.semibold, color: colors.textPrimary },
  ...
  countText: { ...typography.caption, color: colors.background, fontWeight: typography.bold, letterSpacing: 0 },
