...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  sectionTitle: { ...typography.body, fontWeight: typography.semibold, color: colors.textPrimary },
  ...
  rowTitle: { ...typography.bodySmall, fontWeight: typography.semibold, color: colors.textPrimary },
  ...
  stateTitle: { ...typography.body, fontWeight: typography.semibold, color: colors.textPrimary, textAlign: 'center' },
