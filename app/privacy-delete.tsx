...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  lineText: { ...typography.body, flexShrink: 1, color: colors.textPrimary },
  blockers: { gap: spacing.xs },
  blockerText: { ...typography.body, flexShrink: 1, color: colors.textPrimary },
  ...
  destructiveText: { ...typography.bodySmall, fontWeight: typography.semibold, color: colors.errorText },
