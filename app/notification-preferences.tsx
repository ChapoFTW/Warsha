...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  section: { gap: spacing.md, padding: spacing.lg, borderWidth: 1, borderColor: colors.border, borderRadius: radii.lg, backgroundColor: colors.surface }, sectionTitle: { ...typography.h3, fontWeight: typography.bold }, sectionBody: { ...typography.bodySmall, color: colors.textSecondary },
  toggle: { minHeight: 52, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: spacing.lg }, toggleLabel: { ...typography.body, flex: 1 }, reverse: { flexDirection: 'row-reverse' }, timeRow: { flexDirection: 'row', gap: spacing.md, flexWrap: 'wrap' }, timeField: { flex: 1, minWidth: 130, gap: spacing.sm }, timeLabel: { ...typography.bodySmall, color: colors.textSecondary }, input: { minHeight: 48, color: colors.textPrimary, borderWidth: 1, borderColor: colors.border, borderRadius: radii.md, paddingHorizontal: spacing.md, fontSize: typography.h3.fontSize }, zone: { ...typography.bodySmall, color: colors.textMuted },
