...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({row:{minHeight:58,flexDirection:'row',alignItems:'center',justifyContent:'space-between'},reverse:{flexDirection:'row-reverse'},actions:{flexDirection:'row',gap:spacing.sm},control:{height:44,minWidth:44,paddingHorizontal:10,borderRadius:radii.md,borderWidth:1,borderColor:colors.borderSoft,backgroundColor:colors.surface,alignItems:'center',justifyContent:'center'},language:{fontWeight:typography.semibold,fontSize:12},badge:{position:'absolute',top:-5,minWidth:19,height:19,paddingHorizontal:4,borderRadius:10,backgroundColor:colors.white,alignItems:'center',justifyContent:'center',borderWidth:2,borderColor:colors.background},badgeRight:{right:-5},badgeLeft:{left:-5},badgeText:{fontSize:9,lineHeight:11,color:colors.background,fontWeight:typography.bold}});
