...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  note: { color: colors.warning, ...typography.caption, letterSpacing: 0 },
  ...
  devText: { ...typography.caption, letterSpacing: 0 },
  error: { color: colors.error, ...typography.bodySmall },
  success: { color: colors.success, ...typography.bodySmall },
  warning: { color: colors.warning, ...typography.bodySmall, fontWeight: typography.semibold, lineHeight: 18 },
});
