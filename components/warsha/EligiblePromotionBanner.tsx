...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  title: { ...typography.body, fontWeight: typography.semibold, color: colors.textPrimary },
  saves: { ...typography.body, fontWeight: typography.bold, color: colors.textPrimary },
  funded: { ...typography.bodySmall, color: colors.textMuted },
  ...
  applied: { ...typography.bodySmall, fontWeight: typography.semibold, color: colors.successText },
