...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  heading: { ...typography.h3, fontWeight: typography.bold }, itemTitle: { ...typography.bodySmall, fontWeight: typography.semibold }, note: { color: colors.textSecondary, lineHeight: 21 }, muted: { ...typography.bodySmall, color: colors.textMuted }, warning: { ...typography.bodySmall, color: colors.warning }, label: { ...typography.bodySmall, color: colors.textSecondary },
  badge: { maxWidth: '50%', paddingHorizontal: spacing.md, paddingVertical: spacing.sm, borderRadius: radii.pill, backgroundColor: colors.surfaceElevated }, badgeText: { ...typography.caption, letterSpacing: 0, textAlign: 'center' },
  wrap: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm }, choice: { minHeight: 44, justifyContent: 'center', paddingHorizontal: spacing.md, paddingVertical: spacing.sm, borderWidth: 1, borderColor: colors.border, borderRadius: radii.md }, selected: { borderColor: colors.white, backgroundColor: colors.surfaceElevated }, choiceText: { ...typography.bodySmall },
  ...
  action: { minHeight: 48, flexDirection: 'row', gap: spacing.sm, alignItems: 'center', justifyContent: 'center', paddingHorizontal: spacing.md, borderWidth: 1, borderColor: colors.border, borderRadius: radii.lg }, primary: { backgroundColor: colors.white, borderColor: colors.white }, danger: { borderColor: colors.actionDangerBorder }, actionText: { ...typography.bodySmall, fontWeight: typography.semibold, textAlign: 'center' }, primaryText: { color: colors.background }, dangerText: { color: colors.error }, disabled: { opacity: 0.45 },
  source: { paddingHorizontal: spacing.sm, paddingVertical: 6, borderRadius: radii.pill, backgroundColor: colors.surfaceElevated }, sourceText: { ...typography.caption, letterSpacing: 0, color: colors.textSecondary }, evidenceGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm }, evidenceCard: { width: 105, gap: 4, padding: spacing.sm, borderWidth: 1, borderColor: colors.borderSoft, borderRadius: radii.md }, image: { width: '100%', height: 76, borderRadius: radii.sm, backgroundColor: colors.surfaceElevated }, file: { alignItems: 'center', justifyContent: 'center' }, fileName: { ...typography.caption, letterSpacing: 0 },
