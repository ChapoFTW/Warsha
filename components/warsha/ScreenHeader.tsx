...
const styles=StyleSheet.create({row:{flexDirection:'row',alignItems:'center',gap:spacing.md},reverse:{flexDirection:'row-reverse'},back:{width:42,height:42,borderRadius:radii.md,borderWidth:1,borderColor:colors.border,backgroundColor:colors.surface,alignItems:'center',justifyContent:'center'},copy:{flex:1},title:{fontSize:22,fontWeight:typography.bold},subtitle:{fontSize:12,color:colors.textSecondary,marginTop:2}});
