-- Demand rank and active/withdrawn state are catalogue authority owned by the
-- migrations. Seed data may refresh descriptive metadata, but must not restore
-- the retired general-maintenance category or overwrite the 19-category order.
insert into public.service_categories(id,translation_key,description_key,icon_name,sort_order) values
('plumbing','plumbing','plumbingDescription','plumbing',10),('electrical','electrical','electricalDescription','electrical-services',20),('carpentry','carpentry','carpentryDescription','handyman',30),('ac','acRepair','acDescription','ac-unit',40),('cleaning','cleaning','cleaningDescription','cleaning-services',50),('painting','painting','paintingDescription','format-paint',60),('appliance-repair','applianceRepair','applianceRepairDescription','kitchen',70),('satellite-tv-installation','satelliteTv','satelliteTvDescription','satellite-alt',80),('moving-help','movingHelp','movingHelpDescription','local-shipping',90),('general-maintenance','generalMaintenance','generalMaintenanceDescription','home-repair-service',100),
