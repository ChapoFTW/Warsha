...
export type Service = { id:string;
   ...
   */
  translationKey?:string|null; name:string; description?:string; price:number; pricingType:PricingType; transportationFee?:number; emergencySurcharge?:number; duration:string; available?:boolean; inspectionRequired?:boolean };
