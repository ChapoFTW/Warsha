...
const fr: Record<ReviewCopyKey, string> = {
  rateService:'Évaluer ce service',editReview:'Modifier votre avis',editUntil:'Modifiable jusqu’au',editClosed:'La période de modification est terminée.',overall:'Note générale',professionalism:'Professionnalisme',quality:'Qualité',punctuality:'Ponctualité',communication:'Communication',value:'Rapport qualité-prix',comment:'Votre avis',photos:'Photos',photoRules:'Ajoutez uniquement des photos liées au travail, sans information privée.',anonymous:'Afficher mon avis sans mon nom',submit:'Envoyer l’avis',saveChanges:'Enregistrer les modifications',submitted:'Avis envoyé',verifiedBooking:'Travail terminé et vérifié',reviews:'Avis',reputation:'Réputation',noReviews:'Aucun avis pour le moment.',loadError:'Impossible de charger les avis.',tryAgain:'Réessayer',newest:'Plus récents',highestRated:'Mieux notés',lowestRated:'Moins bien notés',mostHelpful:'Les plus utiles',sortReviews:'Trier les avis',helpful:'Utile',notHelpful:'Pas utile',report:'Signaler',reportReason:'Pourquoi signalez-vous cet avis ?',spam:'Indésirable ou trompeur',abuse:'Harcèlement',fakeReview:'Avis probablement faux',offensiveContent:'Contenu offensant',reportDetails:'Informations complémentaires',sendReport:'Envoyer le signalement',reportSent:'Signalement envoyé',providerReply:'Réponse du professionnel',immutableReply:'La réponse publiée reste dans l’historique de l’avis.',averageRating:'Note moyenne',completedJobs:'Travaux terminés',responseRate:'Taux de réponse',completionRate:'Taux d’achèvement',repeatCustomers:'Clients récurrents',yearsOnPlatform:'Années sur Warsha',unavailable:'Indisponible',ratingBreakdown:'Détail des notes',ratingDistribution:'Répartition des notes',confidence:'Fiabilité de la note',confidenceHelp:'Les avis proviennent uniquement de travaux terminés et confirmés.',identityVerified:'Identité vérifiée',skillVerified:'Compétence vérifiée',professionalVerified:'Certificat professionnel vérifié',topRated:'Très bien noté',fastResponder:'Réponse rapide',experienced:'Expérimenté',loading:'Chargement des avis…',image:'Photo de l’avis',imageUnavailable:'Image indisponible',removePhoto:'Supprimer la photo',chooseRating:'Choisissez une note avant de continuer.',reviewError:'Impossible d’enregistrer l’avis.',voteError:'Impossible d’enregistrer votre choix.',reportError:'Impossible d’envoyer le signalement.'
};
export function useReviewText() {
  const { language } = useLocalization();
  return useCallback((key: ReviewCopyKey) => (language === 'fr' ? fr : copy[language])[key], [language]);
}
