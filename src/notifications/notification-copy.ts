...
const catalogue = {
  en: {
    ...
    criminal_record_correction_required: 'Certificate needs attention', criminal_record_correction_requiredBody: 'Something needs correcting on your certificate.',
    criminal_record_received: 'Certificate received', criminal_record_receivedBody: 'Your certificate was received and is being reviewed.',
    criminal_record_required: 'Criminal record certificate required', criminal_record_requiredBody: 'Your application needs a criminal record certificate.',
