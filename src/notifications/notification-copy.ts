...
const financial = {
  ...
  ar: {
    ...
    cash_collection_reported: 'أكد الدفع الكاش', cash_collection_reportedBody: 'الصنايعي سجّل إنه استلم الدفع كاش. أكد لنا اللي حصل.',
