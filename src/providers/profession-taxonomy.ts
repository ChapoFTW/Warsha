...
export const professions = [
  ...
  { key: 'gypsumWorker', categoryId: 'renovation-finishing', serviceCategoryIds: ['renovation-finishing'], serviceKeys: onlyServices('renovation-plastering', 'renovation-gypsum-ceiling', 'renovation-gypsum-decor', 'renovation-inspection'), work: { en: 'Gypsum', ar: 'جبس', fr: 'Plâtrerie' }, person: { en: 'Gypsum worker', ar: 'فني جبس', fr: 'Plâtrier' } },
  ...
  { key: 'glassWorker', categoryId: 'alumetal', serviceCategoryIds: ['alumetal'], serviceKeys: onlyServices('alumetal-window-install', 'alumetal-window-repair', 'alumetal-glass-replace', 'alumetal-shower-cabin'), work: { en: 'Glass', ar: 'زجاج', fr: 'Vitrerie' }, person: { en: 'Glass worker', ar: 'فني زجاج', fr: 'Vitrier' } },
