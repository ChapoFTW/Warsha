...
export const professions = [
  ...
  { key: 'applianceRepair', categoryId: 'appliance-repair', serviceCategoryIds: ['appliance-repair', 'water-heater-repair'], serviceKeys: everyServiceIn('appliance-repair', 'water-heater-repair'), work: { en: 'General appliance repair', ar: 'تصليح عام للأجهزة المنزلية', fr: 'Réparation générale d’électroménager' }, person: { en: 'Appliance technician', ar: 'فني أجهزة منزلية', fr: 'Technicien en électroménager' } },
