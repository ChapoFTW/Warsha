...
export const privacyCopy = {
  en: {
    ...
    availabilityLimited: 'Your privacy information, optional choices and history controls are available below. Account pause, export or deletion appear only when their governed service is enabled.',
    featureUnavailable: 'This governed account action is not enabled in this environment.',

    locationTitle: 'Location and saved addresses',
    locationBody: 'Warsha asks for device location only while you choose a location. Turning off the device permission does not remove an address already saved to your account.',
    locationPermissionTitle: 'Device location permission',
    locationPermissionGranted: 'Allowed while using Warsha',
    locationPermissionDenied: 'Not allowed',
    ...
    historyConfirmTitle: 'Clear this history?',
    historyConfirmBody: 'This removes the selected search or viewing history and cannot be undone.',
    historyConfirmAction: 'Clear history',
    ...
    deactivateConfirmTitle: 'Take a break from Warsha?',
    ...
    communicationsTitle: 'Messages and notifications',
    communicationsBody: 'Choose optional notification channels here. Essential account, safety and booking messages are described separately from marketing choices.',
    manageNotifications: 'Manage notification preferences',
    legalDocumentsBody: 'Read the current terms, privacy notice and other documents that apply to your account.',
    readLegalDocuments: 'Open legal documents',
    cancel: 'Cancel',
  ...
  ar: {
    ...
    availabilityLimited: 'معلومات الخصوصية والاختيارات الاختيارية ومسح السجل متاحين تحت. إيقاف الحساب أو التصدير أو الحذف بيظهروا بس لما الخدمة المنظّمة الخاصة بيهم تكون متاحة.',
    featureUnavailable: 'إجراء الحساب المنظّم ده مش متاح في البيئة دي.',

    locationTitle: 'الموقع والعناوين المحفوظة',
    locationBody: 'ورشة بتطلب موقع الجهاز بس وإنت بتختار مكان. قفل إذن الجهاز مش بيمسح عنوان محفوظ بالفعل في حسابك.',
    locationPermissionTitle: 'إذن موقع الجهاز',
    locationPermissionGranted: 'مسموح أثناء استخدام ورشة',
    locationPermissionDenied: 'مش مسموح',
    locationPermissionUnknown: 'ورشة مقدرتش تقرأ حالة إذن الجهاز.',
    openDeviceSettings: 'افتح إعدادات الجهاز',
    savedLocationTitle: 'معلومات الموقع المحفوظة',
    savedLocationBody: 'العناوين المحفوظة وإحداثيات مطابقة الصنايعي الخاصة بتفضل في حسابك لحد ما تتغير أو تتشال بإجراء حساب مدعوم.',
    ...
    historyConfirmTitle: 'تمسح السجل ده؟',
    historyConfirmBody: 'ده هيمسح سجل البحث أو المشاهدة اللي اخترته ومش هينفع ترجعه.',
    historyConfirmAction: 'امسح السجل',
    ...
    deactivateConfirmTitle: 'تاخد راحة من ورشة؟',
    ...
    communicationsTitle: 'الرسايل والإشعارات',
    communicationsBody: 'اختار قنوات الإشعارات الاختيارية هنا. رسايل الحساب والأمان والحجز الأساسية موضحة بشكل منفصل عن اختيارات التسويق.',
    manageNotifications: 'إدارة تفضيلات الإشعارات',
    legalDocumentsBody: 'اقرأ الشروط الحالية وإشعار الخصوصية والمستندات التانية اللي بتنطبق على حسابك.',
    readLegalDocuments: 'افتح المستندات القانونية',
    cancel: 'إلغاء',
