...
const paymentTranslations = {
  en: {
    ...
    paymentUnavailable: 'Online payment isn’t available yet.',
    tryAgain: 'Try again',
    receipt: 'Receipt',
  ...
  ar: {
    ...
    paymentUnavailable: 'الدفع أونلاين لسه مش متاح.',
    tryAgain: 'حاول تاني',
    receipt: 'الإيصال',
